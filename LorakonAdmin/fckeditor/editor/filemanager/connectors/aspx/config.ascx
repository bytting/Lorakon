...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		//UserFilesAbsolutePath = "C:\\WebApplications\\LorakonAdmin\\userfiles\\";
		...
		TypeConfig[ "File" ].AllowedExtensions			= new string[] { "7z", "aiff", "asf", "avi", "bmp", "cal", "chn", "cnf", "csv", "doc", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "nlb", "ods", "odt", "pdf", "png", "ppt", "pxd", "qaf", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xml", "zip" };
